...
import { Users, Shield, Settings, Check, X, Sliders, Save, Clock, Link2, AlertTriangle, RefreshCw } from 'lucide-react';
                    ...
                    <div className="overflow-x-auto relative">
                        ...
                        <div className="flex justify-end mb-4">
                            <button 
                                ...
                                className="flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-teal-600 bg-gray-50 hover:bg-teal-50 px-3 py-1.5 rounded transition-all border border-gray-200"
                                title="Actualizar lista desde el servidor"
                            >
                                <RefreshCw className={`h-3.5 w-3.5 ${isRefreshingUsers ? 'animate-spin' : ''}`} />
                                {isRefreshingUsers ? 'Actualizando...' : 'Actualizar Lista'}
                            </button>
                        </div>
                                ...
                                {users.map((u, idx) => (
                                    <tr key={idx} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button className="text-teal-600 hover:text-teal-900 font-bold">Editar</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
