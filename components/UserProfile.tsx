  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-bottom-4">
        ...
        <div className="relative mb-8">
            ...
            {/* Banner Background */}
            <div className="h-48 rounded-t-3xl bg-gradient-to-r from-gray-900 via-teal-900 to-gray-900 relative overflow-hidden">
                 <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
                 <div className="absolute bottom-4 right-6 text-white/10 font-black text-6xl select-none hidden sm:block">AURA</div>
            </div>
            
            {/* Profile Info Bar (Matching Gradient Card Overlapping Banner) */}
            <div className="bg-gradient-to-r from-gray-900 via-teal-900 to-gray-900 rounded-b-3xl shadow-xl border-x border-b border-gray-800 px-6 pb-6 pt-0 relative z-10">
                <div className="flex flex-col sm:flex-row items-center sm:items-end -mt-16 sm:-mt-20 gap-6">
                    
                    {/* Avatar */}
                    <div className="relative group shrink-0">
                        <div className="h-32 w-32 sm:h-40 sm:w-40 bg-gray-900 rounded-full p-2 shadow-xl border border-gray-800">
                        ...
                        <div className="absolute bottom-2 right-2 bg-green-500 h-6 w-6 rounded-full border-4 border-gray-900 shadow-sm" title="Activo"></div>
                    </div>
                    
                    {/* Info & Actions */}
                    <div className="flex-1 w-full flex flex-col sm:flex-row sm:items-end justify-between gap-4 text-center sm:text-left pb-2">
                        <div>
                            <h1 className="text-3xl font-black text-white flex items-center justify-center sm:justify-start gap-2 drop-shadow-sm">
                            ...
                            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-y-2 gap-x-4 mt-2 text-gray-300">
                                <span className="bg-black/30 text-teal-300 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-white/10 shadow-sm backdrop-blur-sm">
                                    {user.role}
                                </span>
                                <span className="flex items-center gap-1 text-sm font-medium">
                                    <Fingerprint className="h-4 w-4 text-teal-400/80" />
                                ...
                                <span className="flex items-center gap-1 text-sm font-medium text-gray-300">
                                    <UserCircle className="h-4 w-4 text-teal-400/80" />
                                    {user.username}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="shrink-0">
                            <button 
                                ...
                                className="flex items-center justify-center gap-2 bg-white text-gray-900 px-6 py-3 rounded-xl font-bold shadow-lg transition-all hover:bg-gray-100 hover:-translate-y-0.5 active:translate-y-0 w-full sm:w-auto text-sm border border-gray-200"
                            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden relative">
                    ...
                    <div className="space-y-4 relative z-10">
                        <div>
                            <label className="text-xs text-gray-400 font-bold uppercase">Establecimiento</label>
                        ...
                        <div className="flex gap-4">
                            <div>
                                <label className="text-xs text-gray-400 font-bold uppercase">Código IPRESS</label>
                                <p className="text-sm font-mono font-medium text-gray-700 bg-gray-50 px-2 py-1 rounded w-fit mt-0.5">
                                    {user.facilityData?.code || '---'}
                                </p>
                            </div>
                            <div>
                                <label className="text-xs text-gray-400 font-bold uppercase">Categoría</label>
                                <p className="text-sm font-medium text-gray-700 bg-gray-50 px-2 py-1 rounded w-fit mt-0.5">
            ...
            <div className="lg:col-span-2 space-y-6">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 h-full">
                    <h3 className="text-xs font-bold text-teal-600 uppercase tracking-widest mb-6 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-12">
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-400 uppercase mb-1">Teléfono Celular</label>
